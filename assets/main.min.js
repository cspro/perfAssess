...
function loadContent(pageId, sectionId) {
	...
	// check against existing page, to prevent double loading from redirect
	var currPageId = getPageIdFromHistory();
	var currSectionId = getSectionIdFromHistory();
	if (currPageId == pageId && currSectionId == sectionId) {
		return;
	}
